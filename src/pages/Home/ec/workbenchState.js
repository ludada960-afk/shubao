export const PRODUCT_SLOT_PLAN = [
  { key: 'front', label: '产品图', hint: '上传正面主视图，完整展示商品轮廓' },
  { key: 'angle', label: '补充图', hint: '建议上传 45° 侧面图，补足结构与比例' },
  { key: 'back', label: '补充图', hint: '建议上传背面或俯视图，补足未展示部分' },
  { key: 'detail', label: '补充图', hint: '建议上传材质、接口、纹理或工艺细节' },
  { key: 'scale', label: '补充图', hint: '建议上传手持或使用场景，帮助判断尺度' },
];
