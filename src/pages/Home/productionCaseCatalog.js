...
export const PRODUCTION_CASE_CATALOG = Object.freeze([
  ...
  Object.freeze({
    ...
    assets: Object.freeze([
      ...
      asset({ id: 'tryon-angles-workflow', src: '/images/home/tryon-showcase/editorial-multi-angle-v6.webp?v=fan-only-v1', label: '四张模特多角度成片', role: 'result', ratio: '16:9', intent: 'anything_tryon', taskId: 'ec_production_tryon_complete_20260814_v1', requestKey: 'production-tryon-complete-result', provenance: 'production-composite', displayRole: 'workflowBanner', selectorPreview: true, prompt: '四张同套穿搭的完整模特多角度街拍，采用轻微扇形排版，保留正面、动态、侧面与背面全身比例。' }),
    ]),
  }),
  Object.freeze({
    id: 'tryon-reference',
