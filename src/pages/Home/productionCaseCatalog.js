...
export const PRODUCTION_CASE_CATALOG = Object.freeze([
  ...
  Object.freeze({
    ...
    assets: Object.freeze([
      ...
      asset({ id: 'tryon-angles-workflow', src: '/images/home/tryon-showcase/editorial-multi-angle-v6.webp?v=arrow-clear-v3', label: '商品到多角度成片', role: 'result', ratio: '16:9', intent: 'anything_tryon', taskId: 'ec_production_tryon_complete_20260814_v1', requestKey: 'production-tryon-complete-result', provenance: 'production-composite', displayRole: 'workflowBanner', selectorPreview: true, prompt: '完整展示炭灰长大衣、橄榄绿针织、奶油色阔腿裤、格纹帽、黑色托特包与四个正式生产的全身时尚角度。' }),
    ]),
  }),
  Object.freeze({
    id: 'tryon-reference',
