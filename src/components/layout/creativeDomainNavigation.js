export const CREATIVE_NAV_GROUPS = Object.freeze([
  ...
  Object.freeze({
    ...
    items: Object.freeze([
      Object.freeze({ id: 'video-studio', label: '视频创作', description: '从素材、分镜到候选版本，进入视频工作台', hint: '进入工作台', icon: 'film-strip', motion: 'film', action: { type: 'NAVIGATE', page: 'video-studio' } }),
    ]),
  }),
  Object.freeze({
    id: 'content',
    ...
    items: Object.freeze([
      Object.freeze({ id: 'content-xhs', label: '小红书图文', description: '封面、配图、标题、正文和标签一起生成', hint: '生成图文', icon: 'notebook', motion: 'pages', action: { type: 'SET_MODE', mode: 'content' }, launch: { mode: 'content', subMode: 'content' } }),
      Object.freeze({ id: 'content-plog', label: 'Plog 生活记录', description: '把生活素材整理成有情绪的发布成品', hint: '整理记录', icon: 'camera', motion: 'camera', action: { type: 'SET_MODE', mode: 'content' }, launch: { mode: 'content', subMode: 'plog' } }),
    ]),
  }),
  Object.freeze({
    id: 'visual',
