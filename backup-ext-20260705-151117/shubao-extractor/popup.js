...
(function () {
  ...
  chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
    ...
    appEl.innerHTML = '<div class="empty"><div class="icon">⏳</div><p>正在提取商品信息...</p><p style="font-size:10px;color:#aaa;margin-top:6px">💡 想要提取最全的效果？先把页面往下滑一滑，让详情图都加载出来，再点插件</p></div>';
