...
const ROLE_POLICIES = Object.freeze({
  ...
  white_background: Object.freeze({
    ...
    maxFileBytes: 5_000_000,
    formats: ['jpg', 'png'],
    backgroundPolicy: 'Prefer a true white background and retain clear product edges; verify category-specific exceptions.',
  ...
  detail: Object.freeze({
    ...
    exportSizes: [{ width: 750, height: 1000 }, { width: 800, height: 800 }],
    maxFileBytes: 5_000_000,
    formats: ['jpg', 'png'],
